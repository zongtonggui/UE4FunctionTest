...
void UMyGameInstance::StartRecordingReplayFromBP(FString ReplayName, FString FriendlyName, const TArray<FString>& AdditionalOptions)
{
	StartRecordingReplay(ReplayName, FriendlyName, AdditionalOptions);
}
...
void UMyGameInstance::PlayReplayFromBP(const FString& InName, const TArray<FString>& AdditionalOptions, UWorld* WorldOverride)
{
	PlayReplay(InName, WorldOverride, AdditionalOptions);
}
