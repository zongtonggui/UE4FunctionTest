...
class BPREPLAYSYSTEM_API UMyGameInstance : public UGameInstance
{
	GENERATED_BODY()
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Replays")
		void StartRecordingReplayFromBP(FString ReplayName, FString FriendlyName, const TArray<FString>& AdditionalOptions);
	...
	UFUNCTION(BlueprintCallable, Category = "Replays")
		void PlayReplayFromBP(const FString& InName, const TArray<FString>& AdditionalOptions, UWorld* WorldOverride = nullptr);
