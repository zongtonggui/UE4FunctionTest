...
#include "CustomThunkHelper.generated.h"

/**
 * 
 */
UCLASS()
class EXPLOREUE4_API UCustomThunkHelper : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
	
public:UFUNCTION(BlueprintCallable, Category = "Example", CustomThunk, meta = (CustomStructureParam = "AnyStruct"))
	...
	*/
	static void IterateThroughStructProperty(UStructProperty* StructProperty, void* StructPtr)
	{
		...
		UE_LOG(LogTemp, Warning, TEXT("StructName:%s"), *Struct->GetName());
